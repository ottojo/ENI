...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    ...
    \node[draw,circle,minimum size=40pt,inner sep=0pt] (s11) at (0,3) {$\text{sig}(x)$};
    \node[draw,circle,minimum size=40pt,inner sep=0pt] (s12) at (0,1) {$\text{sig}(x)$};
    \node[draw,circle,minimum size=40pt,inner sep=0pt] (s13) at (0,-1) {$\text{sig}(x)$};
    \node[draw,circle,minimum size=40pt,inner sep=0pt] (s14) at (0,-3) {$\text{sig}(x)$};
    \node[draw,circle,minimum size=40pt,inner sep=0pt] (s21) at (3,1) {$\text{sig}(x)$};
    \node[draw,circle,minimum size=40pt,inner sep=0pt] (s22) at (3,-1) {$\text{sig}(x)$};
